...
#define ASSERT_EQ(msg, got, expected)                                                              \
	do {                                                                                           \
		long _aeq_g = (long)(got);                                                                 \
		long _aeq_e = (long)(expected);                                                            \
		cr_assert_eq(_aeq_g, _aeq_e, "%s: got %ld expected %ld", msg, _aeq_g, _aeq_e);             \
	} while (0)
...
#define ASSERT_NEAR(msg, got, expected, tol)                                                       \
	do {                                                                                           \
		...
		cr_assert_float_eq(_an_g, _an_e, (tol), "%s: got %.6f expected %.6f (tol %.6e)", msg,      \
		                   _an_g, _an_e, (double)(tol));                                           \
	} while (0)
...
static void run_simple_backward(double w_val, double x_val, double b_val, double* gw, double* gb) {
	param_clear();
