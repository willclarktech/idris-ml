 ...
 *
 * The bitlinear_cov suite below adds the dtype-variant arms (F32/F64
 * absmean + ternary-quant + F64 forward dequant) absorbed from the former
 * test_bitlinear_cov_torch.c.
 */
...
/* ----------------------------------------------------------------------
   bitlinear_cov — dtype-variant arms (F32/F64) absorbed from the former
   test_bitlinear_cov_torch.c.
   ---------------------------------------------------------------------- */
