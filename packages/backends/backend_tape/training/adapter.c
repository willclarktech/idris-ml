...
/* ----------------------------------------------------------------------
   ...
   ---------------------------------------------------------------------- */
static int tape_tensor_numel(void* h) {
	return ((Tensor*)h)->numel;
}
static int tape_tensor_requires_grad(void* h) {
	return ((Tensor*)h)->requires_grad;
}
static int tape_tensor_has_grad(void* h) {
	return ((Tensor*)h)->grad != NULL;
}
...
/* ----------------------------------------------------------------------
   ...
   ---------------------------------------------------------------------- */
static double tape_data_read(void* h, int i) {
	return tape_load_d((Tensor*)h, i);
}
static void tape_data_write(void* h, int i, double v) {
	tape_store_d((Tensor*)h, i, v);
}
static double tape_grad_read(void* h, int i) {
	return tape_grad_load_d((Tensor*)h, i);
}
static void tape_grad_write(void* h, int i, double v) {
	tape_grad_store_d((Tensor*)h, i, v);
};
...
/* ----------------------------------------------------------------------
   ...
   ---------------------------------------------------------------------- */
static void tape_adapter_backward(void* loss) {
	tensor_backward((TensorHandle)loss);
}
...
static double tape_adapter_wall_ms(void) {
	return _wall_ms();
}
...
extern TensorHandle tape_create_param_2d_normal_dtag(int rows, int cols, double mean, double std,
                                                     int dtag);
extern TensorHandle tape_create_param_3d_normal_dtag(int d0, int d1, int d2, double mean,
                                                     double std, int dtag);
extern TensorHandle tape_create_param_4d_normal_dtag(int d0, int d1, int d2, int d3, double mean,
                                                     double std, int dtag);
...
extern TensorHandle tape_create_param_4d_const_dtag(int d0, int d1, int d2, int d3, double value,
                                                    int dtag);
extern void tape_set_init_seed(uint64_t seed);

static void* tape_port_create_scalar(double v, int rg, int dtag) {
	return tape_create_scalar_dtag(v, rg, dtag);
}
static void* tape_port_create(double* d, int* s, int r, int rg, int dtag) {
	return tape_create_dtag(d, s, r, rg, dtag);
}
static void* tape_port_create_1d(int n, double* d, int rg, int dtag) {
	return tape_create_1d_dtag(n, d, rg, dtag);
}
static void* tape_port_create_2d(int rows, int cols, double* d, int rg, int dtag) {
	return tape_create_2d_dtag(rows, cols, d, rg, dtag);
}
static void* tape_port_create_param_1d(int n, double* d, int dtag) {
	return tape_create_param_1d_dtag(n, d, dtag);
}
static void* tape_port_create_param_2d(int rows, int cols, double* d, int dtag) {
	return tape_create_param_2d_dtag(rows, cols, d, dtag);
}
static void* tape_port_create_param_3d(int d0, int d1, int d2, double* d, int dtag) {
	return tape_create_param_3d_dtag(d0, d1, d2, d, dtag);
}
static void* tape_port_create_param_4d(int d0, int d1, int d2, int d3, double* d, int dtag) {
	return tape_create_param_4d_dtag(d0, d1, d2, d3, d, dtag);
}
static void* tape_port_create_state_1d(int n, double* d, int dtag) {
	return tape_create_state_1d_dtag(n, d, dtag);
}
static void* tape_port_create_state_2d(int rows, int cols, double* d, int dtag) {
	return tape_create_state_2d_dtag(rows, cols, d, dtag);
}
static void* tape_port_cast_dtype(void* src, int dtag) {
	return tape_cast_dtype_dtag((TensorHandle)src, dtag);
}

/* Fused param create + init trampolines — forward to dtype_init.c. */
static void* tape_port_create_param_1d_normal(int n, double mean, double std, int dtag) {
	return tape_create_param_1d_normal_dtag(n, mean, std, dtag);
}
static void* tape_port_create_param_2d_normal(int rows, int cols, double mean, double std,
                                              int dtag) {
	return tape_create_param_2d_normal_dtag(rows, cols, mean, std, dtag);
}
static void* tape_port_create_param_3d_normal(int d0, int d1, int d2, double mean, double std,
                                              int dtag) {
	return tape_create_param_3d_normal_dtag(d0, d1, d2, mean, std, dtag);
}
static void* tape_port_create_param_4d_normal(int d0, int d1, int d2, int d3, double mean,
                                              double std, int dtag) {
	return tape_create_param_4d_normal_dtag(d0, d1, d2, d3, mean, std, dtag);
}
static void* tape_port_create_param_1d_const(int n, double value, int dtag) {
	return tape_create_param_1d_const_dtag(n, value, dtag);
}
static void* tape_port_create_param_2d_const(int rows, int cols, double value, int dtag) {
	return tape_create_param_2d_const_dtag(rows, cols, value, dtag);
}
static void* tape_port_create_param_3d_const(int d0, int d1, int d2, double value, int dtag) {
	return tape_create_param_3d_const_dtag(d0, d1, d2, value, dtag);
}
static void* tape_port_create_param_4d_const(int d0, int d1, int d2, int d3, double value,
                                             int dtag) {
	return tape_create_param_4d_const_dtag(d0, d1, d2, d3, value, dtag);
}
static void tape_port_set_init_seed(uint64_t seed) {
	tape_set_init_seed(seed);
}
