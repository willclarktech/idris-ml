 ...
 *
 * The `dtype_dispatch_cov` suite below closes the remaining FLOAT dtag
 * case bodies (f32/bf16/f16 arms) left unexercised by the suite above,
 * so every float arm of each dispatcher runs at least once.
 */
...
/* =====================================================================
 * dtype_dispatch_cov — coverage top-up for the FLOAT dtag case bodies
 * (f32/bf16/f16) the suite above leaves unexercised; every float arm of
 * each dispatcher runs at least once after these.
 * ===================================================================== */
