...
extern "C" TensorHandle tensor_embedding_mlx_streamed(TensorHandle hweight, TensorHandle hindices,
                                                      int n, int embedDim, int stream_tag) {
...
extern "C" TensorHandle tensor_embedding_2d_mlx_streamed(TensorHandle hweight,
                                                         TensorHandle hindices, int n, int embedDim,
                                                         int stream_tag) {
	WITH_STREAM(stream_tag);
	(void)n;
	auto* weight = (Tensor*)hweight;
