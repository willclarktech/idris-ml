...
extern "C" TensorHandle tensor_cross_attention_mlx_streamed(TensorHandle hQ, TensorHandle hK,
                                                            TensorHandle hV, TensorHandle hmask,
                                                            double scale, int stream_tag) {
