...
runChunk : {0 d : Device} -> UserDeviceTape d => RuntimeDType dt => Compatible d dt => {i, o, n : Nat} -> {hs : List Nat} ->
...
trainStage : {0 d : Device} -> UserDeviceTape d => RuntimeDType dt => Compatible d dt => {i, o, n : Nat} -> {hs : List Nat} ->
             NativeOptimizer d -> Schedule ->
             Network i hs o d dt WithGrad ->
             Stage d i o n ->
             LossFn d dt o ->
...
export
runCurriculum :
  {d : Device} -> UserDeviceTape d => RuntimeDType dt => Compatible d dt =>
