...
public export
record Stage (0 d : Type) (i : Nat) (o : Nat) (n : Nat) where
  constructor MkStage
  label : String
  threshold : Double
...
runChunk : {0 d : Type} -> UserDeviceCore d => {i, o, n : Nat} -> {hs : List Nat} ->
...
trainStage : {0 d : Type} -> UserDeviceCore d => {i, o, n : Nat} -> {hs : List Nat} ->
             NativeOptimizer -> Schedule ->
             Network i hs o d WithGrad ->
             Stage d i o n ->
             LossFn d o ->
