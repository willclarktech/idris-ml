...
interface LayerLike (l : Nat -> Nat -> (0 _ : Device) -> (0 _ : DType) -> (0 _ : GradMode) -> Type) where
  ...
  applyVar : {0 d : Device} -> UserDeviceTape d => UserDeviceCore d => RuntimeDType dt => {0 g : GradMode} -> {i, o : Nat} ->
  ...
  applyVarBatch : {0 d : Device} -> UserDeviceTape d => UserDeviceCore d => RuntimeDType dt => {0 g : GradMode} -> {i, o : Nat} -> {b : Nat} ->
...
export
applyVarAny : {0 d : Device} -> UserDeviceTape d => UserDeviceCore d => RuntimeDType dt => {0 g : GradMode} -> {i, o : Nat} ->
...
export
applyVarBatchAny : {0 d : Device} -> UserDeviceTape d => UserDeviceCore d => RuntimeDType dt => {0 g : GradMode} -> {i, o : Nat} -> {b : Nat} ->
...
export
forwardVar : {0 d : Device} -> UserDeviceTape d => UserDeviceCore d => RuntimeDType dt => {0 g : GradMode} -> {i, o : Nat} -> {hs : List Nat} ->
...
||| interface default.
export
forwardVarBatch : {0 d : Device} -> UserDeviceTape d => UserDeviceCore d => RuntimeDType dt => {0 g : GradMode} -> {i, o : Nat} -> {b : Nat} ->
                   {hs : List Nat} ->
...
export
forwardVarTraced : {0 d : Device} -> UserDeviceTape d => UserDeviceCore d => RuntimeDType dt => {0 g : GradMode} -> {i, o : Nat} -> {hs : List Nat} ->
                   (label : String) ->
