...
export
applyEmbedding : {0 d : Device} -> UserDeviceTape d => UserDeviceCore d => RuntimeDType dt => Compatible d dt => {seqLen, embedDim, vocab : Nat} ->
...
export
embeddingLayer : UserDeviceTape d => RuntimeDType dt => Compatible d dt => {vocab, embedDim : Nat} -> (paramPrefix : String) ->
...
export
embeddingLayerAny : UserDeviceTape d => RuntimeDType dt => Compatible d dt => {vocab, embedDim, seqLen : Nat} ->
                      (paramPrefix : String) ->
