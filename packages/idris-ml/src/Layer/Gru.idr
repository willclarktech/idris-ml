...
export
applyGru : {0 d : Device} -> UserDeviceTape d => UserDeviceCore d => RuntimeDType dt => Linked d => Compatible d dt => {o : Nat} ->
             GruState i o d dt g ->
             TVec i d dt g ->
...
export
gruLayer : UserDeviceTape d => RuntimeDType dt => Linked d => Compatible d dt => {i, o : Nat} -> (paramPrefix : String) ->
...
export
gruLayerAny : UserDeviceTape d => RuntimeDType dt => Linked d => Compatible d dt => {i, o : Nat} -> (paramPrefix : String) -> IO (AnyLayer i o d dt WithGrad)
