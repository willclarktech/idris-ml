...
export
applyRnn : {0 d : Device} -> UserDeviceTape d => UserDeviceCore d => RuntimeDType dt => Compatible d dt => {o : Nat} ->
             RnnState i o d dt g ->
             TVec i d dt g ->
...
export
rnnLayer : UserDeviceTape d => RuntimeDType dt => Compatible d dt => {i, o : Nat} ->
             (paramPrefix : String) ->
             (activation : {0 g' : GradMode} -> TVec o d dt g' -> IO (TVec o d dt g')) ->
...
export
rnnLayerAny : {0 d : Device} -> UserDeviceTape d => RuntimeDType dt => Compatible d dt =>
