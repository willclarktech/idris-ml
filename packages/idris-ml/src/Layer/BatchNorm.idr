...
export
applyBatchNorm : {0 d : Device} -> UserDeviceTape d => UserDeviceCore d => RuntimeDType dt => Linked d => Compatible d dt => {channels, spatialDim : Nat} ->
                   BatchNormState channels spatialDim
                     (channels * spatialDim)
                     (channels * spatialDim) d dt g ->
...
export
batchNormLayer : UserDeviceTape d => RuntimeDType dt => Linked d => Compatible d dt => {channels, spatialDim : Nat} ->
                   (paramPrefix : String) ->
                   IO (BatchNormState channels spatialDim
                         (channels * spatialDim)
...
||| Wrap in `AnyLayer`.
export
batchNormLayerAny : UserDeviceTape d => RuntimeDType dt => Linked d => Compatible d dt => {channels, spatialDim : Nat} ->
                      (paramPrefix : String) ->
