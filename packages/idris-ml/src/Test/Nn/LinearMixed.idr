...
forwardMixedComputes = do
  ...
  let lyr = the (LinearMixed 3 2 TestExecutor TestDType TestDType) (MkLinearMixed w b)
...
masterGradFlows = do
  ...
  let lyr = the (LinearMixed 2 1 TestExecutor TestDType TestDType) (MkLinearMixed w b)
