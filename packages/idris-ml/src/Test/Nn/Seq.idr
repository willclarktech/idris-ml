...
data Id : Nat -> Nat -> (0 _ : Executor) -> (0 _ : DType) -> Type where
  MkId : Id n n ex dt
...
idLayer : Id 3 3 TestExecutor TestDType
idLayer = MkId
...
seqForwards = do
  ...
  let net = the (Seq 3 3 TestExecutor TestDType) (idLayer :: idLayer :: Nil)
...
seqParamsCompose =
  check "Params (Seq) concatenates element params"
        (length (params (the (Seq 3 3 TestExecutor TestDType) (idLayer :: idLayer :: Nil))) == 0)
