...
bulkToPersistent : {0 d : Device} -> UserDeviceTape d => RuntimeDType dt => Linked d => Compatible d dt => {n : Nat} -> Vector n Double -> AnyPtr
...
freshZeroLossT : {0 d : Device} -> UserDeviceTape d => RuntimeDType dt => Linked d => Compatible d dt => Double -> IO (Tensor [] d dt WithGrad)
...
sumLosses : {0 d : Device} -> UserDeviceTape d => RuntimeDType dt => Linked d => Compatible d dt =>
...
perPointLoss : {0 d : Device} -> UserDeviceTape d => UserDeviceCore d => RuntimeDType dt => Linked d => Compatible d dt => {i, o : Nat} -> {hs : List Nat} ->
               LossFn d dt o ->
...
perPointLossTensor : {0 d : Device} -> UserDeviceTape d => UserDeviceCore d => RuntimeDType dt => Linked d => Compatible d dt => {i, o : Nat} -> {hs : List Nat} ->
                     LossFn d dt o ->
                     Network i hs o d dt WithGrad ->
                     TensorDataPoint i o ->
                     IO (Tensor [] d dt WithGrad)
...
-- accumulate.
recurStep : {0 d : Device} -> UserDeviceTape d => UserDeviceCore d => RuntimeDType dt => Linked d => Compatible d dt => {i, o : Nat} -> {hs : List Nat} ->
            LossFn d dt o ->
...
perSeqLoss : {0 d : Device} -> UserDeviceTape d => UserDeviceCore d => RuntimeDType dt => Linked d => Compatible d dt => {i, o : Nat} -> {hs : List Nat} ->
             LossFn d dt o ->
             Network i hs o d dt WithGrad ->
...
decodeStep : {0 d : Device} -> UserDeviceTape d => UserDeviceCore d => RuntimeDType dt => Linked d => Compatible d dt => {i, o : Nat} -> {hs : List Nat} ->
             LossFn d dt o ->
             AnyPtr ->
             (Network i hs o d dt WithGrad, Tensor [] d dt WithGrad) ->
             Vector o Double ->
...
encodeStep : {0 d : Device} -> UserDeviceTape d => UserDeviceCore d => RuntimeDType dt => Linked d => Compatible d dt => {i, o : Nat} -> {hs : List Nat} ->
             Network i hs o d dt WithGrad ->
             Vector i Double ->
...
perSeqLossTwoPhase : {0 d : Device} -> UserDeviceTape d => UserDeviceCore d => RuntimeDType dt => Linked d => Compatible d dt => {i, o : Nat} -> {hs : List Nat} ->
                     LossFn d dt o ->
                     Network i hs o d dt WithGrad ->
...
export
forwardTwoPhase : {0 d : Device} -> UserDeviceTape d => UserDeviceCore d => RuntimeDType dt => Linked d => Compatible d dt => {i, o : Nat} -> {hs : List Nat} ->
                      Network i hs o d dt WithGrad ->
                      TwoPhaseDataPoint i o Double ->
