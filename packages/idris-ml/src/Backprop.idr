...
perPointLoss : {0 d : Device} -> UserDeviceCore d => {i, o : Nat} -> {hs : List Nat} ->
               LossFn d o ->
...
export
epochVar : {0 d : Device} -> UserDeviceCore d => {i, o, n : Nat} -> {hs : List Nat} ->
            NativeOptimizer ->
...
perPointLossTensor : {0 d : Device} -> UserDeviceCore d => {i, o : Nat} -> {hs : List Nat} ->
                     LossFn d o ->
                     Network i hs o d WithGrad ->
                     TensorDataPoint i o ->
                     Tensor [] d WithGrad
...
export
epochVarTensor : {0 d : Device} -> UserDeviceCore d => {i, o, n : Nat} -> {hs : List Nat} ->
                  NativeOptimizer ->
...
-- targets, mean-reduce.
perRowLoss : {0 d : Device} -> UserDeviceCore d => {n, o : Nat} ->
             LossFn d o ->
...
export
epochVarTensorBatch : {0 d : Device} -> UserDeviceCore d => {i, o, n : Nat} -> {hs : List Nat} ->
                       NativeOptimizer ->
                       Vect n (TensorDataPoint i o) ->
                       LossFn d o ->
                       Network i hs o d WithGrad ->
...
-- accumulate.
recurStep : {0 d : Device} -> UserDeviceCore d => {i, o : Nat} -> {hs : List Nat} ->
            LossFn d o ->
...
perSeqLoss : {0 d : Device} -> UserDeviceCore d => {i, o : Nat} -> {hs : List Nat} ->
             LossFn d o ->
             Network i hs o d WithGrad ->
...
export
epochRecurrentVar : {0 d : Device} -> UserDeviceCore d => {i, o, n : Nat} -> {hs : List Nat} ->
                     NativeOptimizer ->
...
decodeStep : {0 d : Device} -> UserDeviceCore d => {i, o : Nat} -> {hs : List Nat} ->
             LossFn d o ->
...
encodeStep : {0 d : Device} -> UserDeviceCore d => {i, o : Nat} -> {hs : List Nat} ->
             Network i hs o d WithGrad ->
             Vector i Double ->
             Network i hs o d WithGrad
encodeStep net xVec =
...
perSeqLossTwoPhase : {0 d : Device} -> UserDeviceCore d => {i, o : Nat} -> {hs : List Nat} ->
                     LossFn d o ->
                     Network i hs o d WithGrad ->
...
export
epochTwoPhaseVar : {0 d : Device} -> UserDeviceCore d => {i, o, n : Nat} -> {hs : List Nat} ->
                    NativeOptimizer ->
...
-- long eval runs.
export
forwardTwoPhase : {0 d : Device} -> UserDeviceCore d => {i, o : Nat} -> {hs : List Nat} ->
                      Network i hs o d WithGrad ->
                      TwoPhaseDataPoint i o Double ->
