||| Tiny test harness for the idris-transformers package — mirrors
||| the shape of packages/idris-gym/test/src/Harness.idr so any
||| contributor moving between the two packages finds the same
||| primitives.
module Harness
