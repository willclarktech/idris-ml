...
| Taxi | Q-table [500, 6] | Taxi-v4 (tabular, deterministic) | Custom Q-learning | full default 20K ep | ~7 s (measured) | avg_return ≥ 5 | ~7 s (measured) | B6 2026-04-30; 5/5 Idris + 5/5 PyTorch all hit optimal +8 |
