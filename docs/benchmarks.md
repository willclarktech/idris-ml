...
----------------------------------------------------------------------------------------------------
matmul 64x64x64                    5.5       10.5        2.9          1.3      4.1x    7.8x    2.1x
matmul 256x256x256                16.6       11.7       14.1          8.4      2.0x    1.4x    1.7x
matmul 1024x1024x1024             72.5       58.9       65.4         58.2      1.2x    1.0x    1.1x

matvec 256x256                     2.4       21.0        2.6          2.2      1.1x    9.6x    1.2x
matvec 1024x1024                   5.9       11.1        6.0          4.2      1.4x    2.6x    1.4x

add+mul 1000                       3.6       20.1        2.3          1.2      3.1x   17.0x    2.0x
add+mul 10000                     17.4       10.8        7.4          3.1      5.6x    3.5x    2.4x
add+mul 100000                    33.6        7.1       16.0          5.6      6.0x    1.3x    2.9x

softmax 256                        1.0       15.2        1.4          1.1      0.9x   14.1x    1.3x
softmax 1024                       2.0        7.8        2.1          1.5      1.3x    5.1x    1.3x
softmax 10000                      4.2        3.1        3.1          2.7      1.5x    1.2x    1.2x

train_step 64->64                  1.0       14.3        3.1          8.3      0.1x    1.7x    0.4x
train_step 256->256                5.0       11.0       10.4         12.3      0.4x    0.9x    0.8x
train_step 1024->1024              8.5        8.0        3.1          3.3      2.6x    2.4x    0.9x
```
...
---------------------------------------------
BLAS (matmul)         2.4x    3.4x     1.6x
BLAS (matvec)         1.2x    6.1x     1.3x
Element-wise          4.9x    7.3x     2.4x
Softmax               1.3x    6.8x     1.3x
Train step (fwd+bwd)  1.1x    1.7x     0.7x
```
