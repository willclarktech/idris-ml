...
MANIFEST = {
    ...
    "tensor_live_count": Entry(args=("i",), ret="i", slice="UserExecutorDiagnostics", idris_method="primLiveCount", mlx="direct"),
    ...
    "tensor_peak_live_count": Entry(args=("i",), ret="i", slice="UserExecutorDiagnostics", idris_method="primPeakLiveCount", mlx="direct"),
