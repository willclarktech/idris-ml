...
ENTRIES = {
    ...
    "tensor_add_scalar": Entry(
        args=("T", "d"), ret="T", slice="UserExecutorCore", idris_method="primAddScalar"
    ),
    "tensor_add": Entry(args=("T", "T"), ret="T", slice="UserExecutorCore", idris_method="primAdd"),
    "tensor_clamp_min": Entry(
        args=("T", "d"), ret="T", slice="UserExecutorCore", idris_method="primClampMin"
    ),
    "tensor_clamp": Entry(
        args=("T", "d", "d"), ret="T", slice="UserExecutorCore", idris_method="primClamp"
    ),
    "tensor_clone": Entry(args=("T",), ret="T", slice="UserExecutorCore", idris_method="primClone"),
    "tensor_create_scalar": Entry(
        args=("d", "i"),
        ret="T",
        slice="UserExecutorCore",
        idris_method="primCreateScalar",
        torch="bespoke",
    ),
    ...
    "tensor_item_1d": Entry(
        args=("T", "i"), ret="d", slice="UserExecutorCore", idris_method="primItem1d"
    ),
    ...
    "tensor_mul_scalar": Entry(
        args=("T", "d"), ret="T", slice="UserExecutorCore", idris_method="primMulScalar"
    ),
    ...
    "tensor_sigmoid": Entry(
        args=("T",), ret="T", slice="UserExecutorCore", idris_method="primSigmoid"
    ),
